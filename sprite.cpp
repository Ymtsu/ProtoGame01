...
void DrawSpriteVertex(int texNo, D3DXVECTOR2 vertex_left_top, D3DXVECTOR2 vertex_right_top, D3DXVECTOR2 vertex_left_down, D3DXVECTOR2 vertex_right_down, float U, float V, float UW, float VH)
{
		D3D11_MAPPED_SUBRESOURCE msr;
	GetDeviceContext()->Map(g_VertexBuffer, 0, D3D11_MAP_WRITE_DISCARD, 0, &msr);
	...
	vertex[0].Position = D3DXVECTOR3(vertex_left_top.x, vertex_left_top.y, 0.0f);
	vertex[1].Position = D3DXVECTOR3(vertex_right_top.x, vertex_right_top.y, 0.0f);
	vertex[2].Position = D3DXVECTOR3(vertex_left_down.x, vertex_left_down.y, 0.0f);
	vertex[3].Position = D3DXVECTOR3(vertex_right_down.x, vertex_right_down.y, 0.0f);
