...
#define TRIGGER_MIN		(0)				//トリガーの最小値
#define TRIGGER_MAX		(255)			//トリガーの最大値
#define VIBRATION_MIN	(0)				//バイブレーションの最小値
#define VIBRATION_MAX	(255)			//バイブレーションの最大値
...
THUMB_DATA GetThumbLeft(int padNo); //左スティックのxy成分取得　第1引数：パッドのナンバー
int GetThumbRightX(int padNo); //右スティックのx成分取得　第1引数：パッドのナンバー
int GetThumbRightY(int padNo); //右スティックのy成分取得　第1引数：パッドのナンバー
THUMB_DATA GetThumbRight(int padNo); //右スティックのxy成分取得　第1引数：パッドのナンバー
